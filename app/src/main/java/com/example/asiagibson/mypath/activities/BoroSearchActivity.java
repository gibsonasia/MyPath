...
public class BoroSearchActivity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
     ...
     public void onClickButtons(View v) {
        ...
        Intent intent = new Intent(this, YaipDataActivity.class);
        switch (v.getId()) {

            case R.id.manhattan:
                intent.putExtra("borough_community", "Manhattan");
                break;
            case R.id.brooklyn:
